...
import { login, saveUserData } from '../api';
export default function Login() {
  ...
  return (
    <>
        <div style={{minHeight: '100vh',width: '100%',display: 'flex',alignItems: 'center',justifyContent: 'center',padding: '24px',position: 'relative',overflow: 'hidden',backgroundImage:    'linear-gradient(rgba(0, 0, 0, 0.13), rgba(0, 0, 0, 0.13)), url(https://images.pexels.com/photos/1640777/pexels-photo-1640777.jpeg)',backgroundSize: 'cover',backgroundPosition: 'center',backgroundRepeat: 'no-repeat'}}>
            <div style={{position: 'absolute',top: -120,bottom: -140,left: -120,right: -100,width: 340,height: 340,filter: 'blur(2px)',zIndex: 0}}/>
            <div style={{position: 'absolute',inset: 0,boxShadow: 'inset 0 0 160px rgba(0,0,0,0.35)',pointerEvents: 'none',zIndex: 0}}/>
            <form onSubmit={handleSubmit} style={{width: '100%',maxWidth: '480px',background: 'rgba(19, 19, 19, 0.46)',backdropFilter: 'blur(6px)',WebkitBackdropFilter: 'blur(6px)',border: '1px solid rgba(255,255,255,0.45)',borderRadius: '16px',boxShadow: '0 12px 30px rgba(0,0,0,0.18)',padding: '28px 24px',zIndex: 1,color: '#feffffff' }}>
                <div style={{ textAlign: 'center', marginBottom: 12 }}>
                    <h2 style={{ margin: 0, fontWeight: 800, color: '#31e73d' }}>Welcome FoodHub</h2>
                    <p style={{ margin: 0, marginTop: 6, color: '#e4e0caf7' }}>Log in to continue exploring</p>
                </div>
                <div className="mb-3">
